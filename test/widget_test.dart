...
import 'package:coredex_pms/core/language/language.dart';
...
void main() {
  ...
  testWidgets('앱 실행 및 기본 세팅 확인', (WidgetTester tester) async {
    ...
    // 2. Custom Theme test
    // expect(App.navigatorKey.currentContext!.themeType, ThemeType.light);
    // App.navigatorKey.currentContext!.changeTheme(ThemeType.dark);
    // await tester.pump();
    // expect(App.navigatorKey.currentContext!.themeType, ThemeType.dark);
  });
}
